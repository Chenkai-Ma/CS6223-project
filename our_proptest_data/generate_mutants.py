...
def main(args):
    ...
    for i in progress_bar:
        ...
        output_path = f'{args.output_dir}/{function_name}_{dt_string}.jsonl'
        ...
        all_properties = eval_data[i]['properties']
        all_pbts = eval_data[i]['pbt']
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_path', type=str, default='../our_proptest_data/sound_valid/statistics_variance.jsonl')
