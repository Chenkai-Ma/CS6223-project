...
def main(args): 
    ...
    for i in progress_bar:
        ...
        if args.mode == 'properties':
            question = PROPERTIES_PROMPT_DOC_CODE.format(function_name=eval_data[i]['function_name'], api_documentation = eval_data[i]['api_doc'],
            ...
            question_prev = PROPERTIES_PROMPT_DOC_CODE.format(function_name=eval_data[i]['function_name'], api_documentation = eval_data[i]['api_doc'],
                                                               api_code=eval_data[i]['api_code'])
            assistant_props = eval_data[i]['properties'][0]
            question = PBT_PROPERTIES_PROMPT_DOC_CODE.format(function_name_2=function_name_2)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_path', type=str, default='doc_and_code/output_jsonl/property/property_0_30_11-14-18-06.jsonl')
    parser.add_argument('--output_dir', type=str, default='doc_and_code/output_jsonl')
