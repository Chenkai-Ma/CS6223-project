...
def test_datetime_fromordinal_properties(ordinal):
    ...
    # Property 3: Day should be between 1 and the number of days in the corresponding month and year
    assert 1 <= dt.day <= (datetime.datetime(dt.year, dt.month + 1, 1) - datetime.datetime(dt.year, dt.month, 1)).days
